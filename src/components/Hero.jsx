    ...
    <div className='w-screen h-[90vh] p-container font-poppins'>
      <div className="w-full h-full xl:grid grid-cols-2">
        <div className='w-full h-full flex flex-col justify-center'>
          ...
          <p className='text-white font-extralight text-sm md:text-base lg:text-lg xl:text-base 2xl:text-lg leading-loose md:leading-loose lg:leading-loose xl:leading-loose 2xl:leading-loose pt-4 w-full md:w-[80%]'>During my college days I participated in several internal activities as a designer such as designing ui/ux and filling in Instagram content using <span className='font-bold'>Figma</span> and <span className='font-bold'>Adobe XD</span>. Besides that, I have made website projects with 
          ...
          <Link to='/contact' className='text-[#FFD568] flex items-center gap-5 hover:gap-10 ease-in-out duration-200 text-lg md:text-xl mt-12 w-max'>Let's talk <HiArrowNarrowRight/></Link>
        </div>
