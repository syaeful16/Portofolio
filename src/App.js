...
function App() {
  return (
    <>
      ...
      <svg className="absolute top-0 right-0 w-full md:w-[50%] -z-10 blur-[200px]" viewBox="0 0 1161 474" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className="absolute left-0 top-[95vh] w-[16%] -z-10 blur-[200px]" viewBox="0 0 291 1039" fill="none" xmlns="http://www.w3.org/2000/svg">
